...
/*   Updated: 2023/07/20 09:56:10 by qbanet           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_place_colon_point_one(t_3d *obj)
{
	...
	{
		obj->point.x1 = obj->point.x * obj->point.cte1 - obj->point.y *
				obj->point.cte2;
		obj->point.y1 = ((obj->point.pos * Z1IC) + (obj->point.cte1 / 2) *
...
void	ft_place_colon_point_two(t_3d *obj)
{
		if (obj->map.proj == 1)
	{
		...
		obj->point.y2 = obj->point.y + ((obj->point.cte / 2) *
				(obj->map.pad * Z2PC));
	}
	else
	{
		obj->point.x2 = obj->point.x * obj->point.cte1 - obj->point.y *
				obj->point.cte2;
		obj->point.y2 = (obj->point.pos * Z2IC) + (obj->point.cte1 / 2) *
				obj->point.x + (obj->point.cte2 / 2) *
...
void	ft_place_line_point_one(t_3d *obj)
{
	...
	else
	{
		obj->point.x1 = obj->point.x * obj->point.cte1 - obj->point.y *
				obj->point.cte2;
		obj->point.y1 = ((obj->point.pos * Z1IL) + (obj->point.cte1 / 2) *
				obj->point.x + (obj->point.cte2 / 2) * obj->point.y);
	}
}
...
void	ft_place_line_point_two(t_3d *obj)
{
	...
	else
	{
		obj->point.x2 = obj->point.x * obj->point.cte1 - obj->point.y *
				obj->point.cte2;
		obj->point.y2 = (obj->point.pos * Z2IL) + (obj->point.cte1 / 2) *
				obj->point.x + (obj->point.cte2 / 2) *
				(obj->point.y + obj->point.spc);
	}
}